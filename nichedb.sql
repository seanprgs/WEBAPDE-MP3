...
--
-- Host: localhost    Database: nichedb
-- ------------------------------------------------------
...
CREATE TABLE `tags` (
  ...
  PRIMARY KEY (`photoid`),
  KEY `photoid_idx` (`photoid`),
  CONSTRAINT `photoid` FOREIGN KEY (`photoid`) REFERENCES `photos` (`photoid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'seanprgs','1234','weak');
...
-- Dump completed on 2017-07-28 19:46:02
